...
public class DefaultObserverEventHandler : MonoBehaviour
{
    ...
    //METHOD TO CHECK FOR BOAT ON FOUND
    public void checkBoat()
    {

        if ((mObserverBehaviour.TargetName == "trawler" || mObserverBehaviour.TargetName == "trawler_boat2") && 
            boatBtn.name=="TrawlerBtn")
        {
